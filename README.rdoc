...
This small application allows the secure ordering of product for clients. 
There is a front-end with a login form for clients and a form where they can add the ordered amount, there are also discount possibilities.
...
You can check the app here: http://young-journey-7120.herokuapp.com
